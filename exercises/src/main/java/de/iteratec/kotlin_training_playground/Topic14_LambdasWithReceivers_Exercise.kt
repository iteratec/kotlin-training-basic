...
import de.iteratec.kotlin_training_playground.Cleaning.Companion.cleaning
import de.iteratec.kotlin_training_playground.TodoList.Companion.todoList
...
class UnderParentalSupervision {
    ...
    companion object {
/*        fun supervisedTeenagerDoing(actions: ??? -> Any) {
            // Implement me
        }*/
    }
}
